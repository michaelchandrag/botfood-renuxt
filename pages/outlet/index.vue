          ...
          <div class="flex gap-4">
            ...
            <div class="relative">
              <form @submit.prevent="getData">
               <input @keyup.enter.native="getData" type="text" class="pl-10 pr-4 py-3 border border-gray-300 rounded-lg w-full focus:outline-none" v-model="search" placeholder="Nama Outlet">
               </form>
...
<path d="M0.710051 1.71L3.30005 4.3C3.69005 4.69 4.32005 4.69 4.71005 4.3L7.30005 1.71C7.93005 1.08 7.48005 0 6.59005 0H1.41005C0.520051 0 0.0800515 1.08 0.710051 1.71Z" fill="#9E9E9E"/>
            ...
            <div v-if="statusDropdown" class="absolute w-full shadow-sm rounded-b-fds">
              <ul class="w-full border-gray-300">
                <li @click.prevent="statusDropdown=false,isOutletOpen=1,getData()" class="bg-white px-4 py-3 w-full">Buka</li>
                <li @click.prevent="statusDropdown=false,isOutletOpen=0,getData()" class="bg-white px-4 py-3 w-full">Tutup</li>
                <li @click.prevent="statusDropdown=false,isOutletOpen=null,getData()" class="bg-white px-4 py-3 w-full rounded-b-lg">Semua Status</li>
              </ul>
            </div>
            </div>
