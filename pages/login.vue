            ...
            <form class="max-w-sm p-10 bg-white rounded-fd shadow-xl" @submit.prevent="userLogin">
              ...
              <div class="">
                <input v-model="login.slug"
                  ...
                  class="w-full h-12 px-5 py-1 text-gray-700 bg-gray-200 rounded focus:border focus:border-gray-400 focus:outline-none focus:bg-gray-100"
              ...
              <div class="mt-4 items-center flex justify-between">
                <button class="bg-green-food text-white py-3 rounded-lg w-full focus:outline-none focus:opacity-80">
                  ...
                  <span v-if="isLoading">
                    <svg class="h-5 mx-auto animate-spin" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="24"
