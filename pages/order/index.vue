            ...
            <div class="w-full md:w-6/12 lg:w-3/12 cursor-pointer items-center relative p-3">
              ...
              <div v-if="channelDropdown" class="absolute w-full shadow-sm rounded-b-fds">
                <ul class="w-full border-gray-300">
                  <li @click.prevent="channelDropdown=false,filters.state='COMPLETED',getData()"
                    class="bg-white px-4 py-3 w-full">COMPLETED</li>
                  <li @click.prevent="channelDropdown=false,filters.state='CANCELLED',getData()"
                    class="bg-white px-4 py-3 w-full">CANCELLED</li>
                  <li @click.prevent="channelDropdown=false,filters.state=null,getData()"
  ...
  export default {
    ...
    methods: {
      ...
      getData(refresh = false) {
        ...
        this.listLoading = true
        this.$axios.get(`me/orders?${queryParams}`)
          .then(r => {
