  ...
  <div>
    ...
    <div class="bg-gray-200 wrapper-content">
      ...
      <div class="flex flex-wrap -m-2" v-if="!isLoading">
        <item-summary v-for="(d,index) in data.summary" :key="index" :channel="d" class="w-full sm:w-6/12 p-2" />
      </div>
            ...
            <div class="relative">
              <form @submit.prevent="getData">
                <input @change.prevent="getData" type="text"
                  class="pl-10 pr-4 py-3 border border-gray-300 rounded-lg w-full focus:outline-none" v-model="itemName"
          ...
          <table class="table-auto w-full">
            <thead>
              <tr class="border-b">
                ...
                <th class="py-4 text-text text-center cursor-pointer" :class="sortKey==='in_stock'?'filter':''"
                  @click.prevent="sortKey='in_stock', sortValue==='desc' ? sortValue='asc': sortValue='desc',getData(true)">
                  Status
                  <i :class="sortValue==='asc'? 'fa-sort-amount-down': 'fa-sort-amount-up'" class="fas "></i>
                </th>
                <th class="py-4 text-text text-center cursor-pointer"
                  :class="sortKey==='branch_channel_name'?'filter':''"
                  @click.prevent="sortKey='branch_channel_name', sortValue==='desc' ? sortValue='asc': sortValue='desc',getData(true)">
                  Nama Outlet
                  <i :class="sortValue==='asc'? 'fa-sort-amount-down': 'fa-sort-amount-up'" class="fas "></i>
                </th>
                <th class="py-4 text-text text-center cursor-pointer"
                  :class="sortKey==='branch_channel_channel'?'filter':''"
                  @click.prevent="sortKey='branch_channel_channel', sortValue==='desc' ? sortValue='asc': sortValue='desc',getData(true)">
                  Channel
                  <i :class="sortValue==='asc'? 'fa-sort-amount-down': 'fa-sort-amount-up'" class="fas "></i>
                </th>
                <th class="py-4 text-text text-center cursor-pointer" :class="sortKey==='price'?'filter':''"
                  @click.prevent="sortKey='price', sortValue==='desc' ? sortValue='asc': sortValue='desc',getData(true)">
                  Harga
                  <i :class="sortValue==='asc'? 'fa-sort-amount-down ': 'fa-sort-amount-up'" class="fas "></i>
                </th>
                <th class="py-4 text-text text-center cursor-pointer" :class="sortKey==='selling_price'?'filter':''"
                  @click.prevent="sortKey='selling_price', sortValue==='desc' ? sortValue='asc': sortValue='desc',getData(true)">
                  Harga Jual
                  <i :class="sortValue==='asc'? 'fa-sort-amount-down ': 'fa-sort-amount-up'" class="fas "></i>
                </th>
