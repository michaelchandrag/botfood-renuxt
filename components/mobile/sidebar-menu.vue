<template>
  <div>
    <div
      class="p-4 flex bg-white z-50 inset-x-0 fixed top-0 w-full shadow items-center">
      <div class="w-1/2">
        <nuxt-link to="/">
      ...
      <div
        ...
        @click.prevent="showNav ? (showNav = false) : (showNav = true)">
        <svg
          width="24"
          height="18"
          viewBox="0 0 24 18"
    ...
    <div v-if="showNav" class="h-full w-full fixed top-0 z-40 bg-white">
      ...
      <div class="pt-2">
        <ul>
          ...
          <li
            v-if="$route.name == 'm'"
            class="h-12 flex mx-4 rounded-fds items-center px-8 mb-1 bg-green-food text-white">
            <nuxt-link to="/m">
          ...
          <li
            v-if="$route.name != 'm'"
            class="h-12 flex mx-4 rounded-fds items-center px-8 mb-1 text-gray-900">
            <nuxt-link to="/m">
          ...
          <li
            class="flex mx-4 px-8 w-full rounded-fds items-center mb-1 text-gray-900">
            <div class="flex-col w-full">
              <div
                class="cursor-pointer w-full h-12 flex items-center"
                @click.prevent="
                  subMenuLaporan
              ...
              <div v-show="subMenuLaporan || $route.name === 'm-laporan'">
                <ul class="ml-10 mr-2">
                  <li
                    :class="
                      $route.name === 'm-laporan'
                        ? 'h-12 flex rounded-fds items-center px-8 mb-1 bg-green-food text-white'
                        : 'h-12 flex rounded-fds items-center mb-1 '
                    ">
                    <nuxt-link class="block" to="/m/laporan"
                      >Performa Outlet
                    </nuxt-link>
                  </li>
                </ul>
