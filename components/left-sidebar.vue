  ...
  <aside class="sticky top-0 bg-white h-screen pt-2">
    ...
    <div>
      <ul>
        ...
        <!-- menu active -->
        <li v-if="$route.name=='index'" class="btn-height flex items-center px-8 mb-4 bg-green-food text-white rounded-lg">
          <nuxt-link to="/">
            <img class="float-left" src="~/assets/svg/home-active.svg">
            <span class="ml-4">Beranda</span>
          </nuxt-link>
        </li>
        <li v-if="$route.name!='index'" class="btn-height flex items-center px-8 mb-4 text-gray-900 rounded-lg">
          <nuxt-link to="/">
        ...
        <li v-if="$route.name=='outlet'" class="btn-height flex items-center px-8 mb-4 bg-green-food text-white rounded-lg">
         ...
         <li v-if="$route.name!='outlet'" class="btn-height flex items-center px-8 mb-4 text-gray-900 rounded-lg">
          <nuxt-link to="/outlet">
        ...
        <li v-if="$route.name=='item'" class="btn-height flex items-center px-8 mb-2 bg-green-food text-white rounded-lg">
          <nuxt-link to="/item">
            <img class="float-left" src="~/assets/svg/item-active.svg">
            <span class="ml-4">Item</span>
          </nuxt-link>
        </li>
         <li v-if="$route.name!='item'" class="btn-height flex items-center px-8 mb-2 text-gray-900 rounded-lg">
          <nuxt-link to="/item">
      ...
      <div class="absolute bottom-0 mb-12 cursor-pointer btn-height flex items-center px-8 mb-2 text-gray-900 flex" @click.prevent="keluar">
