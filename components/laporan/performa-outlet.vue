    ...
    <form class="w-full max-w-m">
      <div class="md:flex md:items-center mb-6">
        <div class="md:w-full">
          ...
          <label>
            Rekap performa dari rata-rata outlet beroperasi dan rata-rata item
            aktif dalam jangka waktu yang telah ditentukan.
          </label>
        </div>
      </div>
      <div class="md:flex md:items-center mb-6">
...
export default {
  ...
  methods: {
    download() {
      ...
      var queryParams = {
        start_date: this.$moment(this.filters.fromDate).format(
          'YYYY-MM-DD 00:00:00'
        ),
        end_date: this.$moment(this.filters.untilDate).format(
          'YYYY-MM-DD 23:59:59'
        ),
        xlsx: true,
      }
