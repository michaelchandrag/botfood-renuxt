  ...
  <div class="px-4">
    <form action="">
      <div class="mt-4 w-full">
        ...
        <input class="block focus:outline-none w-full mt-1 px-4 py-2 rounded-md border" type="password"  v-model="changePasswordData.oldPassword" placeholder="**************">
      </div>
       <div class="mt-4 w-full">
        <label for="">Password Baru</label>
        <input class="block focus:outline-none w-full mt-1 px-4 py-2 rounded-md border" type="password" v-model="changePasswordData.newPassword"  placeholder="**************">
      </div>
       <div class="mt-4 w-full">
        <label for="">Konfirmasi Password Baru</label>
        <input class="block focus:outline-none w-full mt-1 px-4 py-2 rounded-md border" 
         v-model="changePasswordData.confirmNewPassword" type="password" placeholder="**************">
      </div>
